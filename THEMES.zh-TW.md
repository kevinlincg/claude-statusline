...
> 目前提供 **69 種主題**。使用 `./statusline --menu` 預覽並選擇。
...
### `oneline_powerline`
Powerline 單行：箭頭分隔區段搭配 Powerline 符號

### `twoline_pills`
膠囊雙行：第一行身份與工作區，第二行 API 限制與成本
...
### `htop`
htop：經典系統監視器，彩色進度條風格

![htop](assets/themes/htop.png)

### `btop`
btop：現代系統監視器，漸層色彩與圓角框風格

![btop](assets/themes/btop.png)

### `gtop`
gtop：簡約系統監視器，火花圖與乾淨排版

![gtop](assets/themes/gtop.png)

### `stui`
s-tui：CPU 壓力測試監視器，頻率溫度圖風格
...
### `bbs`
BBS：經典電子佈告欄 ANSI 藝術風格

![bbs](assets/themes/bbs.png)

### `lord`
LORD：紅龍傳說 BBS 經典文字遊戲風格

![lord](assets/themes/lord.png)

### `tradewars`
Trade Wars：太空貿易遊戲，星艦控制台風格

![tradewars](assets/themes/tradewars.png)

### `nethack`
NetHack：經典 Roguelike 地牢探索風格
